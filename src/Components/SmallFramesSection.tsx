...
const SmallFramesSection = () => {
  return (
    <div className="flex mt-[80px] justify-center pb-10 md:flex-row flex-col">
      ...
      <img src={smallframe3} alt="frame3" className="md:ml-[20px] md:w-[20%]" />
      <img src={smallframe4} alt="frame4" className="md:ml-[20px] md:w-[20%]" />
      <img src={smallframe5} alt="frame5" className="md:ml-[20px] md:w-[20%]" />
      <img src={smallframe6} alt="frame6" className="md:ml-[20px] md:w-[20%]" />
    </div>
  );
};
